...
public class WorldGuardManager
{
     ...
     */
    public WorldGuardPlugin getWorldGuard() throws MoogleGenericException
    {
    ...
    public WorldGuardPlugin getTheWorldGuard()
    {
    ...
    public class WorldGuardPlayer extends LocalPlayer
    {
        ...
        public Vector getPosition()
        {
            ...
            {
                SimpleRegionMarket.getPlugin().getLogger().warning(LanguageSupport.instance.getString("worldguard.offlineplayer.getposition"));
        ...
        public void kick(String msg)
        {
            ...
            {
                SimpleRegionMarket.getPlugin().getLogger().warning(LanguageSupport.instance.getString("worldguard.offlineplayer.kick"));
            }
        }
        ...
        public void ban(String msg)
        {
            ...
            {
                SimpleRegionMarket.getPlugin().getLogger().warning(LanguageSupport.instance.getString("worldguard.offlineplayer.ban"));
            }
        }
        ...
        public void printRaw(String msg)
        {
            ...
            {
                SimpleRegionMarket.getPlugin().getLogger().warning(LanguageSupport.instance.getString("worldguard.offlineplayer.message"));
            }
        }
