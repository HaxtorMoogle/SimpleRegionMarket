...
/**
 * An interface that gives a template the general methods to manage owners and
 * members and being able to set a region occupied.
 * 
 * @author theZorro266
 */
public interface OwnableTemplate
{
    ...
    /**
     * Returns all owners of the given region. The owners will be put into an
     * {@link OfflinePlayer} array.
     * 
     * @param region
    ...
    /**
     * Returns all members of the given region. The members will be put into an
     * {@link OfflinePlayer} array.
     * 
     * @param region
    ...
    /**
     * Sets the owners of a region. The owners are in an {@link OfflinePlayer}
     * array.
     * 
     * @param region
     *            as the {@link Region} of which the owners should be set
     * @param owners
     *            in an {@link OfflinePlayer} array as the new owners of that
     *            region
    ...
    /**
     * Sets the members of a region. The members are in an {@link OfflinePlayer}
     * array.
     * 
     * @param region
     *            as the {@link Region} of which the members should be set
     * @param members
     *            in an {@link OfflinePlayer} array as the new members of that
     *            region
     * @return true, if successful
     */
     ...
     * @param player
     *            as the {@link OfflinePlayer} to be added as an owner to the
     *            {@link Region}
     * @return true, if successful
     */
     ...
     * @param player
     *            as the {@link OfflinePlayer} to be added as a member to the
     *            {@link Region}
     * @return true, if successful
     */
     ...
     * @param player
     *            as the {@link OfflinePlayer}, who should be removed from the
     *            list of owners
     * @return true, if successful
     */
    ...
    /**
     * Clears a region. This should remove all owners and members and should set
     * the {@link Region} to a non-occupied state again.
     * 
     * @param region
     ...
     *
     * @param region
     *            as the {@link Region} from which the owner should be get
