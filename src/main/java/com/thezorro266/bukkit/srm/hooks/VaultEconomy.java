...
public class VaultEconomy extends Economy
{
    ...
    public VaultEconomy()
    {
        ...
        if (economy != null)
        {
            SimpleRegionMarket.getInstance().getLogger().info(MessageFormat.format(LanguageSupport.instance.getString("vault.detected.economysystem"), economy.getName()));
        ...
        {
            SimpleRegionMarket.getInstance().getLogger().info(LanguageSupport.instance.getString("vault.notdetected.economysystem"));
        }
    }
                ...
                try
                {
                    ...
                    if (er.type != EconomyResponse.ResponseType.SUCCESS)
                    {
                        SimpleRegionMarket.getInstance().getLogger()
                                .warning(MessageFormat.format(LanguageSupport.instance.getString("vault.economy.problem"), er.type.toString() + ": " + er.errorMessage));
                    }
                    else
                    {
                        return true;
